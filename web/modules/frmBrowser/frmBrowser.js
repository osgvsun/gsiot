App.code.debug.frmBrowser.code = function (name, app) {
    ...
    this.Show=function(){
        console.log("wsc_receive:" + this.Name);this.app.Forms.activeForm = this;
        ...
        if(this.tmpl!=null){
            ...
            else{data=[];console.log(this.data.result);this.data.result.ForEach(function(item,index){if(item.InspectionRecord.length!=0)data.Add(item);});this.data.result=data;this.data.PublicServation=this.PublicServation};
            this.parent.Tmpl(this.tmpldata,this.data); 
            console.log(this.data.PublicServation);
    ...
    this.CheckPolicy = function () {
        ...
        this.app.policy.data.ForEach(function (policy, index) {
            console.log(policy.devindex+"=="+App.cfg.release.device.id+":"+(policy.devindex == App.cfg.release.device.id))
            console.log(policy.devindex+"=="+devindex+":"+(policy.devindex == devindex))
